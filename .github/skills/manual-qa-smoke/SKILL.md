...
description: 'Manual smoke test workflow for ACMECertManager. Use for pre-release validation of launch, staging issuance flow, certificate persistence, theme persistence, and auto-renew scheduler setup.'
...
- Confirm Windows-specific behaviors such as Task Scheduler registration and port 80 challenge handling assumptions.
...
7. Trigger Enable Auto-Renew and verify task registration feedback appears without unhandled exceptions.
8. Review logs for clear success or failure messages and no silent fatal errors.
